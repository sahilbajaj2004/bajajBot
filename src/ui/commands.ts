...
export const COMMANDS: CommandDef[] = [
  ...
  { name: "/subagent", description: "Fan out parallel background agents — any number of tasks" },
  { name: "/fallback", description: "Pick auto-failover models for rate-limit/provider-down turns (no arg = picker)" },
  { name: "/route", description: "Smart routing — match keywords/regex in a message to auto-pick the model" },
  { name: "/ollama", description: "Detect your local Ollama server, set up a profile, and switch to it" },
  { name: "/map", description: "Show the project map the agent sees" },
  { name: "/sn", description: "Prompt snippets — /sn inserts, /sn save <name> stores your last prompt" },
  { name: "/todo", description: "Persistent per-project todos — agent can add/tick them while working" },
  ...
  { name: "/commit", description: "AI-written commit message · y to commit the whole working tree" },
